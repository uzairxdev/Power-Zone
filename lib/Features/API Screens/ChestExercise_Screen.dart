...
class ChestExerciseScreen extends StatefulWidget {
  const ChestExerciseScreen({Key? key}) : super(key: key);

  @override
  State<ChestExerciseScreen> createState() => _ChestExerciseScreenState();
}
...
class _ChestExerciseScreenState extends State<ChestExerciseScreen> {
  ...
  Future<List<Model>> getBackApi() async {
    var uri =
        Uri.https('exercisedb.p.rapidapi.com', '/exercises/bodyPart/chest');
