...
class UpperArmsExScreen extends StatefulWidget {
  const UpperArmsExScreen({Key? key}) : super(key: key);

  @override
  State<UpperArmsExScreen> createState() => _UpperArmsExScreenState();
}

class _UpperArmsExScreenState extends State<UpperArmsExScreen> {
  List<Model> backList = [];

  Future<List<Model>> getBackApi() async {
    var uri = Uri.https(
        'exercisedb.p.rapidapi.com', '/exercises/bodyPart/upper%20arms');
